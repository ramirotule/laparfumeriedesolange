      ...
      <div className="relative bg-[#0D0D0D] border border-[#D4AF37]/30 max-w-lg w-full p-8 md:p-12 shadow-2xl shadow-black">
        ...
        {status === "success" ? (
          <div className="text-center py-8 animate-fade-in">
            ...
            <h3 className="text-2xl font-serif text-white mb-2">¡Bienvenido a la Colección!</h3>
            <p className="text-gray-400">Te has suscrito correctamente. Pronto recibirás nuestras novedades exclusivas.</p>
          </div>
        ) : (
