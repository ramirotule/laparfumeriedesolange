    ...
    <div className="w-full">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Foto de Solange */}
          <div className="relative aspect-[3/4] max-h-[500px] bg-[#0D0D0D] border border-[#1A1A1A] overflow-hidden">
            <Image
            ...
            />
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent px-4 pb-4 pt-8">
