    ...
    <>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-[#888888] text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
          <span className="text-white text-xs tracking-widest uppercase">Descubrí</span>
      ...
      {/* FAMILIAS OLFATIVAS */}
      <section className="bg-[#050505] border-y border-[#1A1A1A] py-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {familias.map((familia) => (
              <Link
                ...
                className="group bg-[#0D0D0D] border border-[#1A1A1A] hover:border-[#D4AF37]/40 p-6 text-center transition-all duration-300 hover:shadow-lg hover:shadow-[#D4AF37]/10"
              >
      ...
      {/* SECCIÓN ÁRABES CTA */}
      <section className="relative overflow-hidden bg-gradient-to-r from-[#0A0A0A] via-[#111008] to-[#0A0A0A] border-y border-[#D4AF37]/20 py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-[#888888] text-lg max-w-2xl mx-auto mb-2 leading-relaxed">
