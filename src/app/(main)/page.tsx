    ...
    <>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-9xl text-white leading-tight mb-4 tracking-normal">
            <span className={greatVibes.className}>La</span>
            <span
              className={`block text-[#D4AF37] -mt-4 md:-mt-8 ${greatVibes.className}`}
            >
              Parfumerie
            </span>
          </h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {familias.map((familia) => (
              ...
              >
                ...
                <p className="text-[#555555] text-xs leading-snug">
                  {familia.descripcion}
                </p>
              </Link>
            ))}
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-black via-[#0D0D0D] to-black border-y border-[#D4AF37]/20 py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto mb-2 leading-relaxed">
            El arte milenario de la perfumería oriental. Oud, ámbar, rosas
            árabes y especias exóticas en fragancias de larga duración.
          </p>
