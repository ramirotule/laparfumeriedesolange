    ...
    <>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center bg-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-black leading-none mb-6 tracking-wide">
            La
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-black">Novedades</h2>
            </div>
            <Link
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {familias.map((familia) => (
              <Link
                ...
                className="group bg-white border border-gray-100 hover:border-[#D4AF37]/40 p-6 text-center transition-all duration-300 hover:shadow-lg hover:shadow-[#D4AF37]/10"
              >
                <div className="text-3xl mb-3">{familia.emoji}</div>
                <h3 className="text-black font-semibold text-sm mb-1 group-hover:text-[#D4AF37] transition-colors">
                  {familia.nombre}
                </h3>
                <p className="text-gray-400 text-xs leading-snug">{familia.descripcion}</p>
              </Link>
            ))}
          </div>
        </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-black">Destacados</h2>
            </div>
            <Link
      ...
      {/* SECCIÓN ÁRABES CTA */}
      <section className="relative overflow-hidden bg-gradient-to-r from-gray-50 via-white to-gray-50 border-y border-[#D4AF37]/20 py-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="font-serif text-lg text-black mb-2">Visitanos</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-lg text-black mb-2">Consultas</h3>
            <a
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-lg text-black mb-2">Instagram</h3>
            <a
